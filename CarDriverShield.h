/**
  ...
  * @version V1.0
  * @date    2013-05-16
  * @brief   This file provides all the MotorDriver firmware functions.
  ******************************************************************************
    @note
...
#define MOTOR_SPEED_TURN_SLOW           120						/*!< slow side speed of turning */
...
#define MOTOR_TIME_PERIOD				(2)			/*!< motor speed refresh period */
